...
excerpt: "I developed a set of consumer-facing systems with modern technology stack for a delivery company. The systems helped the company processed over 500K delivery orders for shipment tracking with 70% infrastructure cost reduced."
...
I helped a delivery company revamp its mobile app, which supports the daily work of its 700 frontline couriers to handle over 8K daily orders. The renovated app reduced the development time by 30% with Flutter and saved 10% battery usage after optimization.
...
<Stats>
    ...
    <StatItem label="Delivery orders handled">500K+</StatItem>
</Stats>